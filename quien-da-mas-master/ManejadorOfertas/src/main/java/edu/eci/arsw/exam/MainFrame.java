...
public class MainFrame extends javax.swing.JFrame implements MessageListener {
    ...
    //AGR
    private ManejadorOfertasSkeleton mos = null;
    int nPropuestas = 0;
    ...
    //AGR
    public void setManejadorOfertasSkeleton(ManejadorOfertasSkeleton mos) {
        this.mos = mos;
    }
    ...
    private void botonEnvioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonEnvioActionPerformed
        try {
            Product ts = 
            new Product(this.codigoTareaTF.getText(), this.descripcionTareaTF.getText(), Integer.parseInt(this.startPriceField.getText()));
            ...
            //fpers = new FachadaPersistenciaOfertas();
    ...
    public void onMessage(Message msg) {
        try {
            Product receivedProduct = new Product(msg.getBody());
            //System.out.println("\n VENDEDOR recibió: "+receivedProduct.getCode());
            /*jTextArea2.setText(jTextArea2.getText()+"\n CodPro: "+receivedProduct.getCode()
                               + "\n ID: "+receivedProduct.getDescription()
                               + "\n Oferta: "+receivedProduct.getStartPrice());*/
            
            if(nPropuestas < 3)
                mos.agregarOferta(receivedProduct.getDescription(), receivedProduct.getCode(), receivedProduct.getStartPrice());
            
            //System.out.println("\n "+fpers.getMapaOferentesAsignados());
            ...
            if(nPropuestas == 3){
                ...
                jTextArea2.setText("\n PROPUESTA GANADORA: "
                                  +"\n - ID: " + fpers.getMapaOferentesAsignados().get(receivedProduct.getCode())
                                  +"\n - Monto: " + fpers.getMapaMontosAsignados().get(receivedProduct.getCode()));
                
                Product ts = 
                new Product(receivedProduct.getCode(), 
                            fpers.getMapaOferentesAsignados().get(receivedProduct.getCode()), 
                            fpers.getMapaMontosAsignados().get(receivedProduct.getCode()));
